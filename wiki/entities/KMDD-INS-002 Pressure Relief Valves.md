---
title: "KMDD-INS-002 Pressure Relief Valves"
type: entity
tags: [work]
created: 2026-06-13
updated: 2026-06-19
...
- 2026-04-24 — TBC#1 Rev.A issued to ATA; process DTS (KDP-DDA/KMA-03-DS-I-0003-D0-1) shared; deadline 04-May
- 2026-05-20 — TBC#1 Rev.B issued
- 2026-05-28 — TBC#1 Rev.D issued; TBC#2 deadline set 01-Jun
- 2026-06-03 — TBC#2 deadline 15:45 04-Jun-26 issued; HIPPS leakage PSV added to base scope (4 tags)
- 2026-06-04 — ATA + An Phu responded TBC#2 Rev.B by 15:45 deadline; TTE/KLE/Thanh An in parallel rounds
- 2026-06-08 — KLE responded TBC#2 Rev.B (datasheets, drawings, cost impact, Form T5/T9)
- 2026-06-09 — Thanh An resubmitted Form T9 + TBC#2 Rev.B; waiting factory data (gasket + lifting lugs TBC#1 Rev.C items)
...
- **ATA (ATA Engineering Solutions)** — sub-supplier: Trillium Flow-France; acknowledged TBC#2 Rev.C 12-Jun 07:29; deadline COB 15-Jun
...
- **CA Category:** CAT B
- **Scope addition Jun 3:** 4 HIPPS leakage PSV tags added to base scope (KM-WHP + DD-WHP)
- **Ferrite requirement:** 45-55% per spec; Italian foundry (Technical Srl) states standard is 35-55%; argues 40-42% needed for low-temp toughness compliance — potential spec contradiction
- **TBC structure:** TBC#2 with multiple Rev iterations per bidder as technical items are resolved

## Connections

- [[KMDD Project]] — parent project; procurement issues
- [[HIPPS Overpressure Protection]] — HIPPS leakage PSV tags added to scope Jun 3; INS-002 scope now covers HIPPS downstream protection
- [[Technical Bid Clarification Process]] — TBC#2 Rev.C issued to 5 bidders simultaneously 12-Jun
- [[KMDD INS-002 HIPPS PSV Base Scope Addition]] — scope change Jun 3; 4 tags added; all bidders affected
- [[Offshore Piping Material Selection]] — ferrite content requirement dispute involves DSS (duplex stainless steel) material selection

## Source References

- [[KMDD INS-002 HIPPS PSV Base Scope Addition]] — HIPPS leakage PSV scope change Jun 3 (2026-06-04)
- [[KMDD TBC EOD Jun 4]] — ATA + An Phu responded TBC#2 by deadline; INS-002 went active (2026-06-05)
